...
public class PZLayoutManager extends org.pzgui.PZManager {
    ...
    public static Layout<Vertex, Edge> testLayout = null;
    ...
    public static Transformer<Vertex,Point2D> Initialization;
    ...
    public static JButton refreshButton = new JButton("Reconnection after 3 sec");
    public static JCheckBox displayIsland = new JCheckBox("Show all island hosts. ");
    private JPanel rightPanel = new JPanel();
    private JPanel flowTablePanel = new JPanel();
    private JPanel buttonPanel = new JPanel();
    
    public static int rpWidthCheck = 0;
    
    
    
    public static JPanel flowInfoPanel = new JPanel();
    public static JTextArea flowTable = new JTextArea(38,36);
    public static JScrollPane scroller = new JScrollPane(flowInfoPanel);   
    ...
    public void windowResized(PZWindow window) {
        ...
        //add by wunyuan                    
		ImageIcon logoIcon = new ImageIcon(PZLayoutManager.class.getResource("/org/images/logo.png"));	
        Image img = logoIcon.getImage();  
        Image logoImage = img.getScaledInstance(300, 139,  java.awt.Image.SCALE_SMOOTH);  
        logoIcon = new ImageIcon(logoImage);     
        JLabel label = new JLabel("", logoIcon, JLabel.CENTER);  

        flowInfoPanel.removeAll();
        flowInfoPanel.revalidate();
        flowInfoPanel.repaint();
        ...
        flowTable.setText("Please click flow to show flow information.");
    	flowInfoPanel.add(flowTable);
    	...
    	displayIsland.addItemListener(cba);
