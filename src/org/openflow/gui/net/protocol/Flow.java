...
public class Flow {
    ...
    public Flow(final FlowType type, final int id, Node srcNode, short srcPort, Node dstNode, short dstPort, FlowData fd, final FlowHop... path) {
        this.type = type;
        this.id = id;
    ...
    public Flow(final FlowType type, final int id, Node srcNode, short srcPort, Node dstNode, short dstPort, FlowData fd, final Collection<FlowHop> path) {
        this.type = type;
        this.id = id;
        this.srcNode = srcNode;
        this.srcPort = srcPort;
    ...
    public FlowData getFlowDataClass()
    {
    	return flowData;
    }
