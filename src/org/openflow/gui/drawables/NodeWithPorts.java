...
public abstract class NodeWithPorts extends Node {
    ...
    private CtlType controllerType;
    ...
    public NodeWithPorts(NodeType type, String name, int x, int y, Icon icon, String ctrIp) {
        super(name, x, y, icon);
        String [] subIpString = ctrIp.split("#");
        this.controllerIp = subIpString[0];
        
        switch(Integer.valueOf(subIpString[1]))
        {
        case 1:
        	controllerType = CtlType.Floodlight;
        	break;
        case 2:
        	controllerType = CtlType.NOX;
        	break;
        }
        this.type = type;
    }
    ...
    public CtlType getControllerType()
    {
